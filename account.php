  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Arpit Mishra" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">Arpit Mishra</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+918317071907</h4>
		<h4 style="font-family:'typo' ">arpit.mishra_cs21@gla.ac.in</h4>
